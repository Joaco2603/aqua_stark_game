...
// Manejo de diferentes versiones de Unity para XR/VR
...
namespace Ceto
{
    public static class OceanVR
    {
        ...
        public static void Initialize()
        {
#if UNITY_540_OR_HIGHER && CETO_USE_STEAM_VR
#if UNITY_2020_1_OR_NEWER
                // Para Unity 2020+, verificar si XR está habilitado
                ...
                OpenVRInUse = xrDisplaySubsystems.Count > 0 && XRSettings.loadedDeviceName == "OpenVR";
#elif UNITY_2017_2_OR_NEWER
